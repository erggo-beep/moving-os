...
import { Tooltip, SelectableCard, SelectDropdown, TextInput, Checkbox } from '@moving-company/ui';
import type { AddressFormData } from '@moving-company/types';

interface PropertySectionProps {
  data: Pick<AddressFormData, 'propertyType' | 'squareMeters' | 'squareMetersNotApplicable' | 'floor' | 'multipleFloors' | 'elevator'>;
